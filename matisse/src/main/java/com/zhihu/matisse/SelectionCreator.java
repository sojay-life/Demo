...
public final class SelectionCreator {
     ...
     * @return
     */
    public SelectionCreator videomaxSize(int size) {
     ...
     * @return
     */
    public SelectionCreator videominSize(int size) {
        mSelectionSpec.videoMinSize = size;
        return this;
    }
    /**
    ...
    public SelectionCreator setVideoType(int videoType) {
        mSelectionSpec.videoType = videoType;
        return this;
    }
    public SelectionCreator setIsActivity(boolean isActivity) {
        mSelectionSpec.isActivity = isActivity;
        return this;
    }
