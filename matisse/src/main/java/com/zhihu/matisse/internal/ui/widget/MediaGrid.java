...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        media_gray = findViewById(R.id.media_gray);
        ...
        if (mListener != null) {
            if (v == mThumbnail) {
                if (!is_video)
                    ...
                    mListener.onClickVideo(mThumbnail, mMedia, mPreBindInfo.mViewHolder);
    ...
    public void setCheckEnabled(boolean enabled) {
        if (!enabled && !is_video)
            media_gray.setVisibility(VISIBLE);
        else
            media_gray.setVisibility(GONE);
    ...
    public interface OnMediaGridClickListener {
        ...
        void onClickVideo(ImageView mThumbnail, Item mMedia, RecyclerView.ViewHolder mViewHolder);
    }
