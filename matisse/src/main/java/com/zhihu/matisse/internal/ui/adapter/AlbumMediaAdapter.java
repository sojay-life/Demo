...
public class AlbumMediaAdapter extends
    ...
    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedCollection, RecyclerView recyclerView, boolean isVideo) {
        super(null);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            ...
            return new MediaViewHolder(v, isVideo);
        }
        return null;
    }
    ...
    public void setOnRequestPermissionsListener(AlbumMediaAdapter.onRequestPermissionsListener onRequestPermissionsListener) {
    ...
    private static class MediaViewHolder extends RecyclerView.ViewHolder {
        ...
        MediaViewHolder(View itemView, boolean isVideo) {
            super(itemView);
            mMediaGrid = (MediaGrid) itemView;
