...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public static final String SHOW_TYPE = "show_type";             //展示样式
    public static final String SHOW_CUR = "show_cur";             //默认进入展示position
    private boolean showType;                                       // 图库进入  false /   外部进入true
    ...
    protected TextView tv_preview_position;
    protected TextView tv_preview_count;
    protected ImageView iv_remove;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        showType = getIntent().getBooleanExtra(SHOW_TYPE, false);
        findViewById(R.id.iv_finish).setOnClickListener(this);
        tv_preview_position = findViewById(R.id.tv_preview_position);
        tv_preview_count = findViewById(R.id.tv_preview_count);
        ...
        mPreviousPos=getIntent().getIntExtra(SHOW_CUR,0);
        ...
        iv_remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Item item = mAdapter.getMediaItem(mPreviousPos);
                if (mSelectedCollection.isSelected(item))
                    mSelectedCollection.remove(item);
                if (mSelectedCollection.count() == 0) {
                    ...
                    mPager.setScroll(false);
                mAdapter.removeItem(mPreviousPos);
                mAdapter.notifyDataSetChanged();
                tv_preview_position.setText(mPreviousPos+1 + "/" + mAdapter.getCount());
            }
        });
        ...
        if (showType) {
            tv_preview_position.setVisibility(View.VISIBLE);
            tv_preview_position.setText(mPreviousPos+1 + "/" + mSelectedCollection.count());
            iv_remove.setVisibility(View.VISIBLE);
            tv_preview_count.setVisibility(View.GONE);
            mCheckView.setVisibility(View.GONE);
            mButtonApply.setVisibility(View.GONE);
        } else {
            tv_preview_position.setVisibility(View.GONE);
            iv_remove.setVisibility(View.GONE);
            tv_preview_count.setVisibility(View.VISIBLE);
    ...
    public void onPageSelected(int position) {
        ...
        if (mPreviousPos != -1 && mPreviousPos != position) {
            ((PreviewItemFragment)adapter.getItem(position)).resetView();
    ...
    private void updateApplyButton() {
        ...
        if (selectedCount == 0) {
            ...
            mButtonApply.setEnabled(true);
            mButtonApply.setText(R.string.button_sure_default);
            tv_preview_count.setText(selectedCount + "");
        }
